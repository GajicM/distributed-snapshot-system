...
public class AppConfig {
	...
	public static final SnapshotVersionId version = new SnapshotVersionId(0);
	...
	public static void readConfig(String configName){
		...
		for (int i = 0; i < serventCount; i++) {
			...
			//Ovde dodajem u listu inicijatora
			String[] initiatorIds=properties.getProperty("initiators").split(",");
			for(String id:initiatorIds) {
				newInfo.addInitiator(Integer.parseInt(id));
			}
