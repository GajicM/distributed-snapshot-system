...
//				AppConfig.timestampedErrorPrint("Sending message: "+messageToSend.toString()+" with version: "+messageToSend.getVersionVector().getVersionId() + " and AppConfigVersion: "+AppConfig.version)	;
//				if (AppConfig.isWhite.get() == false) {
//					messageToSend = messageToSend.setRedColor(); //updateVersion
//				}
				if(AppConfig.version.getVersionId()>messageToSend.getVersionVector().getVersionId()){
					messageToSend.setVersionVector(AppConfig.version);//TODO MOZDA?
				}
	//			AppConfig.timestampedErrorPrint("Sending message: "+messageToSend.toString()+" with version: "+messageToSend.getVersionVector().getVersionId() + " and AppConfigVersion: "+AppConfig.version.getVersionId());
